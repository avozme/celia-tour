    ...
    <div id="content" class="col100">
        <div id="table" class="col80">
            ...
            @foreach ($zones as $zone)
                ...
                <div class="col10 row15">{{ $zone->name }}</div>
                ...
                <div class="col5 row15"> <input type="button" value="Edit" onclick="window.location.href='{{ route('zone.edit', $zone->id) }}'"> </div>
                <div class="col5 row15"> <input type="button" value="Delete" onclick="window.location.href='{{ route('zone.delete', $zone->id) }}'"> </div>
            @endforeach
        </div>
