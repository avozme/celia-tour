...
<script type="text/javascript" src="{{ url('js/updateTable.js') }}"></script>
@endsection
@section('content')
    ...
    <div id="content" class="col100"> 
        ...
        <div style="clear: both;">
            ...
            <div class="col30"><input type="file" name="file_preview" value="{{$guidedVisit->file_preview ?? ''}}" required><br></div>
        </div>
    </div>
